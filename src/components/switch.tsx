...
export default function Switch({
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2">
      <AnimatePresence>
        {isHovered && (
          <motion.button
            ...
            className="hidden md:flex items-center justify-center w-[2rem] h-[2rem] border rounded-full"
          >
      ...
      <motion.button
        className="bg-white w-[3rem] h-[3rem] drop-shadow backdrop-blur-[0.5rem] border rounded-full flex items-center justify-center dark:bg-black"
        variants={switchVariants}
        initial="visible"
        whileHover="hover"
